...
const Hero = () => {
    ...
    <div id="hero" data-testid="hero" className='w-dvw col-span-1 col-sart-1 row-span-1 row-start-1 grid grid-rows-[60dvh_auto] lg:grid-rows-[100dvh] grid-cols-[100dvw] lg:grid-cols-[55dvw_1fr] bg-neutral-cream-bg absolute'>
        <div style={{background: `url(${heroBackground})`}} id='hero-photo' className="flex flex-col justify-end overflow-hidden !bg-fixed !bg-cover !bg-no-repeat !bg-[center_-5dvh] lg:!bg-[-22dvw_top] h-full w-dvw lg:w-[55dvw]">
            ...
            <img src={mobileDeco} alt='Eucaliptus and lavander self-start' className='w-min object-contain h-[15vh] relative left-0 top-[18vh] rotate-[-5deg] lg:hidden' />
